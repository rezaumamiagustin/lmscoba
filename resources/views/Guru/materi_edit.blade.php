    ...
    <div class="container">
        <div class="card mt-5">
            ...
            <div class="card-body">
                ...
                <form method="post" action="/Guru/materi/{{ $materi->id }}" enctype="multipart/form-data">
                    @csrf
                    @method('patch')
                    ...
                    <div class="form-group">
                        ...
                        <select name="id_detMapel" id="id_detMapel">
                            ...
                            {{-- {{ $dm->detmap_mapel->nama_mapel}} - {{ $dm->detmap_guru->nama_guru}} --}}
                            {{-- <option value="{{  $materi->id_detMapel }}">{{ $detMap->detmap_mapel->mapel->nama_mapel }}</option> --}}
                    ...
                    <div class="form-group">
                        <label>Desc Materi</label>
                            ...
                            value="{{ old('desc_materi', $materi->desc_materi) }}"></textarea>
                    ...
                    <div class="form-group">
                        <img src="{{ asset('storage/fileMateri/'. $materi->file_materi) }}" height="50%" width="100%">
                        @if($errors->has('file_materi'))
                        <div class="text-danger">
                            {{ $errors->first('file_materi')}}
                        </div>
